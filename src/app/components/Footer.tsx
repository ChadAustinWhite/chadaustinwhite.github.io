...
export function Footer({ onNavigateHome }: FooterProps = {}) {
  ...
  return (
    <footer className="flex flex-col items-start gap-4 border-t border-[var(--border)] px-[var(--cs-page-gutter)] py-7 md:flex-row md:items-center md:justify-between md:py-9">
